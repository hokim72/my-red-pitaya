proc getPresetInfo {} {
  return [dict create name {red_pitaya} description {red_pitaya}  vlnv xilinx.com:ip:processing_system7:5.5 display_name {red_pitaya} ]
}
...
return [dict create \
    ...
    CONFIG.PCW_M_AXI_GP0_FREQMHZ {142}  \
